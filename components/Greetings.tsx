  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/asset/background-present-ghany2.jpg"
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <p className="text-white/80 text-sm">
                Leading product development and strategic planning
              </p>
            </div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
              ...
              <p className="text-white/80 text-sm">
                Expert in financial systems and enterprise solutions
              </p>
            </div>
          ...
          <div className="mb-12">
            <p className="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">
              Welcome to my digital portfolio where I showcase my journey in
              technology, business development, and continuous learning.
            </p>
