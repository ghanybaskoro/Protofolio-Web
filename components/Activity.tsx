import { FileText, Image as ImageIcon, ExternalLink, Calendar, Tag, Globe, Code } from 'lucide-react'
...
export default function Activity() {
  const activities: Activity[] = [
    {
      ...
      type: 'pdf',
      thumbnail: '/asset/Gekko-pitchdeck.jpg',
    ...
    },
    {
      ...
      type: 'pdf',
      thumbnail: '/asset/kotig-pitchdeck.jpg',
    ...
    {
      id: 'sql-analysis-project',
      title: 'SQL Data Analysis Simulation Operational & Inventory Optimization for NusaMart Retail Chain',
      description: 'This project demonstrates my SQL skills in data analysis and simulation to optimize operational and inventory processes for NusaMart, a retail chain.',
      date: '2026',
      category: 'Data Analysis',
      type: 'pdf',
      thumbnail: '/asset/ERDfinal.jpg',
      fileUrl: 'https://drive.google.com/file/d/1GN-Ip5REoz5lNNuaDMyz4JTwwn6iyQjZ/view?usp=sharing',
      tags: ['SQL', 'Data Analysis', 'Simulation', 'Operational Optimization', 'Inventory Optimization']
    },
    {
      id: 'credit-scoring-project1',
      title: 'Logia AI: Integrated Credit Scoring & Fraud Validation System (Prototype Simulation)',
      description: 'Logia AI integrates credit scoring and fraud validation using machine learning to assess loan applicant risk and detect fraudulent applications (Prototype Simulation).',
      date: '2026',
      category: 'AI & Machine Learning',
      type: 'colab (.ipynb)',
      thumbnail: '/asset/logia-credit-scoring.jpg',
      fileUrl: 'https://colab.research.google.com/drive/1IzMhw-sg1NuPEi8Ci7ocHqxJA5oCaToA?usp=sharing',
      tags: ['AI', 'Machine Learning', 'Credit Scoring', 'Fraud Detection', 'Python']
    },
    {
      id: 'samudera-komoditas',
      title: 'Samudera Komoditas Indonesia - Company Profile & CMS',
      description: 'Dynamic company profile website with a product catalog. Includes a dedicated Admin page for content management, built using Next.js and Supabase as the database. This project was developed with the assistance of AI tools.',
      date: '2026',
  ...
  const getFileIcon = (type: string) => {
    ...
    if (type === 'colab (.ipynb)') return Code
    return ImageIcon
  }

  const getFileTypeColor = (type: string) => {
    if (type === 'pdf') return 'bg-red-100 text-red-800'
    if (type === 'website') return 'bg-emerald-100 text-emerald-800'
    if (type === 'colab (.ipynb)') return 'bg-yellow-100 text-yellow-800'
                  ...
                  {activity.thumbnail ? (
                    ...
                    <div className="text-center p-4">
                      <div className="relative">
                        ...
                        {activity.id === 'sql-analysis-project' && (
                          <div className="absolute -top-1 -right-1 w-4 h-4 bg-cyan-500 rounded-full flex items-center justify-center">
                            <div className="w-2 h-2 bg-white rounded-full"></div>
                          </div>
                        )}
                        {activity.id === 'credit-scoring-project1' && (
