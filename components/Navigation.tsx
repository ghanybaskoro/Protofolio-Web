    ...
    >
      <div className="container-custom">
        <div className="flex items-center justify-between h-16">
          <div
            className={`flex items-center gap-3 text-xl font-bold transition-colors duration-300 ${
              isInGreetings && !scrolled ? "text-gray-900" : "gradient-text"
            }`}
          >
            <Image
              src="/asset/Logo_Logia_Initiative-removebg.png"
              alt="Logia Initiative Logo"
              width={489}
              height={217}
